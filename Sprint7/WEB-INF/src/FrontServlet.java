            ...
            if (apres_contexte != null) {
                for (String key : mapping_url.keySet()) {
                    if (apres_contexte.equals(key)) {
                        ...
                        if (ob.getClass().getDeclaredMethod(mapping_url.get(key).getMethod()).getReturnType()
                                .getSimpleName().equals("void")) {
                        ...
                        } else if (ob.getClass().getDeclaredMethod(mapping_url.get(key).getMethod()).getReturnType()
                                .getSimpleName().equals("ModelView")) {
