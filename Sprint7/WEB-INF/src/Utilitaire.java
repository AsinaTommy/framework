...
public class Utilitaire {
    ...
    public static void afficher_MappingUrls(HashMap<String, Mapping> mappingUrls, PrintWriter out) {
        ...
        for (int i = 0; i < keys.size(); i++) {
            out.println("key:" + keys.get(i) + " , " + "(classname = " + mappingUrls.get(keys.get(i)).getClassName()
                    + " " + "; method = " + mappingUrls.get(keys.get(i)).getMethod() + ")");
        }
    }
